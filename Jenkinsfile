...
post {
      success {
		...
		jiraSendDeploymentInfo branch: 'master', site: 'jira-jenkins-test.atlassian.net', environmentId: 'us-prod-1', environmentName: 'us-prod-1', environmentType: 'production'
        	}
	   else if ( "${env.BRANCH_NAME}" == "qa" )
                  {
